...
float pesq_interpolate (float    freq, 
...
{ 
    ...
    float   overallGainFilter = pesq_interpolate ((float) 1000, filter_curve_db, number_of_points); 
    ...
    for (i = 0; i <= pow_of_2/2; i++) { 
        factorDb = pesq_interpolate (i * freq_resolution, filter_curve_db, number_of_points) - overallGainFilter;
